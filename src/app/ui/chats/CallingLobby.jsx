...
// handle incoming call from other side peer
  const handleIncomingCall = async (SDP) => {
    console.log('this is OFFER SDP:',SDP);
     handleWebcam()
...
if(peerConnection &&  answer){
  console.log('this is peerConnection befoe setRemote Description:',peerConnection);
  console.log('this is its state:',peerConnection.signalingState);
